...
This is auto-generated by Github Actions, but if you would like to generate
it on your own system, first clone the repo, then install the Python
dependencies (preferably within a Python virtual environment)
using this command:
```
